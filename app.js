...
function memberCardScreenshot(url) {
  return url
    ? `<a class="member-card-screenshot-link" href="${escapeHtml(url)}" target="_blank" rel="noopener noreferrer" aria-label="Open full screenshot in new tab"><span class="member-card-screenshot-label">Screenshot</span><img class="member-card-screenshot" src="${escapeHtml(url)}" alt="Submitted build screenshot" loading="lazy" decoding="async" /></a>`
    : "";
}
