...
function memberScreenshotField(url) { return url ? `<section class="member-detail-field"><h4>Screenshot</h4><img class="member-screenshot" src="${escapeHtml(url)}" alt="Submitted build screenshot" loading="lazy" decoding="async" /></section>` : ""; }
